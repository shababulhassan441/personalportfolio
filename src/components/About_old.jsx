...
const About = () => {
  return (
    <div className="max-w-[1200px] mt-[80px] mx-auto" id="about">
        <h1 className="text-black text-6xl max-w-[320px] mx-auto font-semibold p-4 mb-4">About <span className="text-orange-500">Me</span></h1>
